...
<nav class="main-nav navbar-expand-md" role="navigation">  
      ...
      <div class="container">
                ...
                <div class="tagline">
                    <p><h3><b>The framework which simplifies building of complex System</b></h3></p>
                    <p>Version<i class="fas fa-heart"></i> v1.1.5</p>
                </div><!--//tagline-->
                ...
                <div class="social-container">
	                ...
	                <div class="github-btn mb-2">
						<a class="github-button" href="https://github.com/SoftyNg/systemx/" data-size="large" 
                        aria-label="Star xriley/PrettyDocs-Theme on GitHub"></a>
                        <a class="github-button" href="https://github.com/SoftyNg" data-size="large" 
                        aria-label="Follow @xriley on GitHub">Follow @SoftyNg</a>
	                </div>
	                <!-- Replace with your Twitter Button -->
                    <div class="twitter-tweet">
                        <a href="https://twitter.com/systemx_mvc?ref_src=twsrc%5Etfw" class="twitter-follow-button"
                         data-show-count="false">Follow @Systemx_mvc</a>
...
<section class="cards-section text-center">
            <div class="container">
                ...
                <div class="intro">
                    <p>Welcome to <?php echo site_info('name'); ?>. This landing page is dynamically generated by
systemx, feel free to go through the available simple tutorials to guide you in building complex Systems easily. 
                ...
                <div id="cards-wrapper" class="cards-wrapper row">
                    <div class="item item-green col-lg-4 col-6">
                        <div class="item-inner">
                            ...
                            <p class="intro">The Quick Guide has tutorials and reference documentation for the
                                 components that make up the framework. Visit the <a href>Quick Guide !</a>
							</p>
